...
if ( isset( $_SESSION[ 'tutors_admin' ] ) ) {
  Redirect('../hub/hub');
}
...
if ( isset( $_POST ) & !empty( $_POST ) ) {
  ...
  //a function created in common_functions.php, it returns True or False if the person can log in
	if(valid_admin_login($username, $password, $connection)){
    $logged_in = find_login_admin_id($username, $connection);
    $_SESSION[ 'tutors_administrator' ] = $logged_in;

    Redirect('../hub/admin_hub');
  } else {
